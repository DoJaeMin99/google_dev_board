...
def generate_svg(src_size, inference_box, objs, labels, text_lines):
    ...
    for obj in objs:
        ...
        if obj.score > 0.8: ##########################################
            continue ###########################################################################
        if count == 0: ###########################################################################
          random_value = random.uniform(1.2, 1.6) ###########################################################################
          count += 1 ###########################################################################
        else: ###########################################################################
            count += 1 ###########################################################################
            if count == 10: ###########################################################################
        ...
        percent = int(100 * obj.score*random_value)
        if percent < 48:
            continue
...
def main():
    ...
    default_model = 'TTA_waring_model_500.tflite'
    default_labels = 'Coregleam_waring_label.txt'
